        ...
        <?php
            if(!isset($_SESSION['loggedin'])) {
                ...
                <div class="not-logged-in">
                    ...
                    <button onclick="location.href=\'/sklep/login.php\'" class="login-button pink-button">Zaloguj się</button>
                    <span>lub</span>
                    <button onclick="location.href=\'/sklep/register.php\'" class="register-button pink-button">Zarejestruj się</button>
                </div>';
            } else {
