...
--
-- Dumping data for table `kategoria_1`
--
...
--
-- Dumping data for table `kategoria_2`
--
...
CREATE TABLE `metoda_dostawy` (
  ...
  `zdjecie_sciezka` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

--
-- Dumping data for table `metoda_dostawy`
--
...
INSERT INTO `metoda_platnosci` (`metoda_platnosci_id`, `rodzaj`, `zdjecie_sciezka`) VALUES
(1, 'BLIK', '/sklep/images/payment/blik.png'),
(2, 'PayU', '/sklep/images/payment/payu.png');
...
--
-- Dumping data for table `ulubiony`
--
...
--
-- AUTO_INCREMENT for table `kategoria_1`
--
ALTER TABLE `kategoria_1`
  MODIFY `kategoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `kategoria_2`
--
ALTER TABLE `kategoria_2`
...
--
-- Constraints for table `kategoria_1`
--
ALTER TABLE `kategoria_1`
...
--
-- Constraints for table `kategoria_2`
--
ALTER TABLE `kategoria_2`
...
ALTER TABLE `koszyk`
  ...
  ADD CONSTRAINT `koszyk_ibfk_2` FOREIGN KEY (`uzytkownik_id`) REFERENCES `uzytkownik` (`uzytkownik_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `koszyk_ibfk_3` FOREIGN KEY (`sesja_id`) REFERENCES `sesja` (`sesja_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `produkt`
--
ALTER TABLE `produkt`
  ADD CONSTRAINT `produkt_ibfk_1` FOREIGN KEY (`marka_id`) REFERENCES `marka` (`marka_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `produkt_ibfk_2` FOREIGN KEY (`kategoria_id`) REFERENCES `kategoria_2` (`kategoria_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ulubiony`
--
ALTER TABLE `ulubiony`
