...
if (isset($_GET['subcategory'])) {
    $pizda = ' WHERE kategoria_2.kategoria_id=' . $_GET['subcategory'];
}
if (isset($_GET['category'])) {
    $pizda = ' WHERE kategoria_1.kategoria_id=' . $_GET['category'];
}
if (isset($_GET['maincategory'])) {
    $pizda = ' WHERE kategoria.kategoria_id=' . $_GET['maincategory'];
}
        ...
        <ul>
            ...
            foreach ($glowneKategorie as $glownaKategoria) {
                ...
                foreach ($podkategorie as $podkategoria) {
                    ...
                    echo "<li>
                    <a class='subcategory uppercase' href='?category=" . $podkategoria['kategoria_id'] . "'>" . $podkategoria['kategoria'] . "</a><ul>";

                    foreach ($podpodkategorie as $podpodkategoria) {
                        echo "<li><a class='subsubcategory' href='?subcategory=" . $podpodkategoria['kategoria_id'] . "'>" . $podpodkategoria['kategoria'] . "</a></li>";
                    }
