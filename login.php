        ...
        <div class='login-container'>
            <div class='login-container-section'>
                ...
                <form method='POST' action='php/login.php'>
                    ...
                    <input type='password' class='login-field' name='password' id='password_login' required>
            ...
            <div class='login-container-section'>
                ...
                <button onclick="location.href='register.php'"class='register-button white-button' >Zarejestruj się</button>
            </div>
        </div>
    </main>
